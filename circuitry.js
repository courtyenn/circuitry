...
Circuitry.prototype.createWire = function(){
  ...
  for(var x = 0; x < this.wireCount; x++){
    ...
    var wire = new Wire({
      'startPoint': {x: circuitry.startPoint.x, y: circuitry.startPoint.y},
      'patternName': circuitry.patternName
    });
...
Circuitry.prototype.drawPattern = function(){
  var circuitry = this;
  var pattern = circuitry.patternName;
...
Circuitry.prototype.draw = function(){
  var circuitry = this;
  switch(circuitry.patternName){
    case 'RandomStart':
    circuitry.drawRandomStart();
    break;
    case 'Upwards':
    circuitry.drawPattern();
    break;
    default:
    circuitry.drawRandomStart();
    break;
